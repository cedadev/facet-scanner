...
ALL_FACETS = [BROADER_PROCESSING_LEVEL, DATA_TYPE, ECV, FREQUENCY, INSTITUTION, PLATFORM, PLATFORM_PROGRAMME, PLATFORM_GROUP, PROCESSING_LEVEL, PRODUCT_STRING, PRODUCT_VERSION, SENSOR, PROJECT]
